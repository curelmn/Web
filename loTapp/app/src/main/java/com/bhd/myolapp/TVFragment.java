...
public class TVFragment extends Fragment{
    ...
    private Button timeSelectopentv;
    private Button timeSelectclosetv;
    private TextView txtTimeopentv;
    private TextView txtTimeclosetv;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle saveInstanceState) {
        ...
        timeSelectopentv = view.findViewById(R.id.time_select_opentv);
        timeSelectclosetv = view.findViewById(R.id.time_select_closetv);
        txtTimeopentv= view.findViewById(R.id.txt_time_opentv);
        txtTimeclosetv= view.findViewById(R.id.txt_time_closetv);
        return view;
    }
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        //定时
        timeSelectopentv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Calendar calendar= Calendar.getInstance(Locale.CHINA);
                showTimePickerDialog(getActivity(),  5, txtTimeopentv, calendar);
            }
        });
        timeSelectclosetv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Calendar calendar= Calendar.getInstance(Locale.CHINA);
                showTimePickerDialog(getActivity(),  6, txtTimeclosetv, calendar);
            }
        });
    }
        ...
        new TimePickerDialog( activity,themeResId,
                ...
                new TimePickerDialog.OnTimeSetListener() {
                    ...
                    public void onTimeSet(TimePicker view, int hourOfDay, int minute) {
                        switch(themeResId){
                            case 5:
                                tv.setText("您选择了开启时间：" + hourOfDay + "时" + minute  + "分");
                                break;
                            case 6:
                                tv.setText("您选择了关闭时间：" + hourOfDay + "时" + minute  + "分");
                                break;}
