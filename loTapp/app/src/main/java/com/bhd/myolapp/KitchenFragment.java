...
public class KitchenFragment extends Fragment {
    ...
    private ImageView kitchenDpxs;

    private Button btnOpenKitchen;
    private Button btnCloseKitchen;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle saveInstanceState) {
        ...
        View view=inflater.inflate(R.layout.kitchen_fragment,null);
        mSharedPreference = this.getActivity().getSharedPreferences(SP_TEST, Context.MODE_PRIVATE);


        btnOpenKitchen= view.findViewById(R.id.btn_open_kitchen);
        btnCloseKitchen = view.findViewById(R.id.btn_close_kitchen);
        kitchenDpxs = view.findViewById(R.id.kitchen_dpxs);
...
//        txtTime= view.findViewById(R.id.txtTime);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        //开灯
        btnOpenKitchen.setOnClickListener(new View.OnClickListener()  {
            @Override
...
//                    socket = new Socket(ip,port);
                    ...
                    getActivity().runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            if("kitchen_open".equals(msg)){
                               kitchenDpxs.setImageResource(R.drawable.dp_light);
                                Toast.makeText(getActivity().getApplicationContext(), "已经打开", Toast.LENGTH_SHORT).show();
                            }else{
                               kitchenDpxs.setImageResource(R.drawable.dp_dark);
