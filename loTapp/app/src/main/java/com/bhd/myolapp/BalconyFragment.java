...
public class BalconyFragment extends Fragment {
    ...
    private ImageView balconyDpxs;

    private Button btnOpenBalcony;
    private Button btnCloseBalcony;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle saveInstanceState) {
        ...
        View view=inflater.inflate(R.layout.balcony_fragment,null);
        mSharedPreference = this.getActivity().getSharedPreferences(SP_TEST, Context.MODE_PRIVATE);


        btnOpenBalcony = view.findViewById(R.id.btn_open_balcony);
        btnCloseBalcony = view.findViewById(R.id.btn_close_balcony);
       balconyDpxs = view.findViewById(R.id.balcony_dpxs);
...
//        txtTime= view.findViewById(R.id.txtTime);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        //开灯
        btnOpenBalcony.setOnClickListener(new View.OnClickListener()  {
            @Override
        ...
        //关灯
     btnCloseBalcony.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
...
//                    socket = new Socket(ip,port);
                    ...
                    getActivity().runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            if("balcony_open".equals(msg)){
                                balconyDpxs.setImageResource(R.drawable.dp_light);
                                Toast.makeText(getActivity().getApplicationContext(), "已经打开", Toast.LENGTH_SHORT).show();
                            }else{
                                balconyDpxs.setImageResource(R.drawable.dp_dark);
